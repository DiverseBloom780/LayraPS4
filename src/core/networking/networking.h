...
struct Config {
  ...
  bool lan_play_enabled = false;
  bool dns_spoofing_enabled = false;
...
private:
  ...
  // Placeholder for the actual LAN Play tunnel implementation (e.g., a UDP
  // socket and a separate thread)
...
namespace Common {
template <> struct Singleton<Core::Networking::NetworkingCore> {
