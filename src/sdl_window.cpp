...
WindowSDL::WindowSDL(s32 width_, s32 height_, Input::GameController* controller_, Core::Emulator* emulator_,
                         std::string_view window_title)
    : width{width_}, height{height_}, controller{controller_}, emulator{emulator_} {
    Common::Singleton<Core::Networking::NetworkingCore>::Instance()->Init();
    if (!SDL_SetHint(SDL_HINT_APP_NAME, "LayraPS4")) {
...
WindowSDL::~WindowSDL() {
Common::Singleton<Core::Networking::NetworkingCore>::Instance()->Shutdown();
}
